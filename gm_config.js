...
var GM_config = {
 init: function(title, settings, css) {
    if (typeof title=='string') this.title = title; else { settings = title; css = settings }
 ...
 open: function() {
	...
	if(obj.title) frameBody.lastChild.appendChild(obj.create('p', {id:'config_desc',className:'config_desc',innerHTML:obj.title}));
